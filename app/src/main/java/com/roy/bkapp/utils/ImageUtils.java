...
*/
    ...
    public static String getCacheSize() {
        try {
            return getFormatSize(getFolderSize(new File(BkKit.getContext().getExternalCacheDir() + File.separator + BkKit.getContext().getPackageName())));
        } catch (Exception e) {
            e.printStackTrace();
            return "获取失败";
        }
    ...
    public static void clearDiskCache(ClearCacheListener clearCacheListener){
        new AsyncTask<Void,Void,Void>(){
            ...
            protected Void doInBackground(Void... params) {
                Glide.get(BkKit.getContext()).clearDiskCache();
                return null;
