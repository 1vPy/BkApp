...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private static final String PATH = Environment
            .getExternalStorageDirectory().getPath() + "/" + BkKit.getContext().getString(R.string.app_name) + "/log/";
    ...
    private void uploadExceptionToServer(String path) {
        ...
        BkApplication.getAppComponent().getBmobApiService().uploadCrash(path, new RequestCallback<String>() {
            @Override
            public void onSuccess(String s) {
                //Toast.makeText(BkKit.getContext(), "" + s, Toast.LENGTH_LONG).show();
                LogUtils.log(TAG, "" + s, LogUtils.DEBUG);
            }

            @Override
            public void onFailure(String message) {
                //Toast.makeText(BkKit.getContext(), "" + message, Toast.LENGTH_LONG).show();
